...
// World
// __x_X_X_x__x_X_X_x__x_X_X_x__x_X_X_x__x_X_X_x__x_X_X_x__x_X_X_x__x_X_X_x__x_X_X_x__
    G4double world_sizeX = 80*cm;
    G4double world_sizeY = 80*cm;
...
// __x_X_X_x__x_X_X_x__x_X_X_x__x_X_X_x__x_X_X_x__x_X_X_x__x_X_X_x__x_X_X_x__x_X_X_x__
    ...
    G4VPhysicalVolume* physScint =
        new G4PVPlacement(0,                            //no rotation
            G4ThreeVector(5.*cm,0.*cm,0.*cm),           //at (0,0,0)
...
// __x_X_X_x__x_X_X_x__x_X_X_x__x_X_X_x__x_X_X_x__x_X_X_x__x_X_X_x__x_X_X_x__x_X_X_x__
// Light Guide Stuff following now!!
...
// __x_X_X_x__x_X_X_x__x_X_X_x__x_X_X_x__x_X_X_x__x_X_X_x__x_X_X_x__x_X_X_x__x_X_X_x__
    G4VPhysicalVolume* LGPhys1 =
        new G4PVPlacement(0,                            //no rotation
            G4ThreeVector(5.*cm,0.*cm,-55.*cm),         //at (0,0,0)
...
// __x_X_X_x__x_X_X_x__x_X_X_x__x_X_X_x__x_X_X_x__x_X_X_x__x_X_X_x__x_X_X_x__x_X_X_x__
// Photomultiplier Tube Section following!
...
// Scintillator 1 PMT Physical Volumes
// __x_X_X_x__x_X_X_x__x_X_X_x__x_X_X_x__x_X_X_x__x_X_X_x__x_X_X_x__x_X_X_x__x_X_X_x__
    G4VPhysicalVolume* PMTPhys1 =
        new G4PVPlacement(0,                            //no rotation
            G4ThreeVector(5.*cm,0.*cm,-60.5*cm),        //at (0,0,0)
...
void muonSDSimDetectorConstruction::ConstructSDandField()
{
    G4SDManager::GetSDMpointer()->SetVerboseLevel(1);
    
    // declare crystal as a MultiFunctionalDetector scorer
    G4MultiFunctionalDetector* scintBlock = new G4MultiFunctionalDetector("SDnameScint");
    G4SDManager::GetSDMpointer()->AddNewDetector(scintBlock);
    G4VPrimitiveScorer* primitiv = new G4PSEnergyDeposit("edep");
    scintBlock->RegisterPrimitive(primitiv);
    SetSensitiveDetector("Logic_Scintillator",scintBlock);
}
