...
{ 
    ...
    analysisManager->CreateH1("deltaTime","Time Difference of Muon and Secondary Particles",100, 0.,20000.,"microsecond");
}
...
void muonSDSimRunAction::EndOfRunAction(const G4Run* run)
{
    ...
    G4double fac = (mm/MeV)/(nofEvents * binWidth);
    // analysisManager->ScaleH1(0, fac);
